...
if __name__ == 'main':
    ...
    active_products, inactive_products, weather_data_processed, order_data_su, camp = data_prep_wrapper(
    ...
    def ts_cleaner(y):
        ...
        if adf_resid < 0.05:
            print("Product {} is stationary after correcting for shocks.".format(y.name))
        else:
            print("Product {} is not stationary after correcting for shocks.".format(y.name))

        if jarque_bera(resid)[1] < 0.05:
            print("Product {} errors are normal after correcting for shocks.".format(y.name))
        else:
            print("Product {} are not normal after correcting for shocks.".format(y.name))
        ...
        if adf_resid < 0.05:
            print("Product {} is stationary after correcting for seasons.".format(y.name))
        else:
            print("Product {} is not stationary after correcting for seasons.".format(y.name))

        if jarque_bera(resid)[1] < 0.05:
            print("Product {} errors are normal after correcting for seasons.".format(y.name))
        else:
            print("Product {} are not normal after correcting for seasons.".format(y.name))
        ...
        if adf_resid < 0.05:
            print("Product {} is stationary after correcting for autocorrelation.".format(y.name))
        else:
            print("Product {} is not stationary after correcting for autocorrelation.".format(y.name))

        if jarque_bera(resid)[1] < 0.05:
            print("Product {} errors are normal after correcting for autocorrelation.".format(y.name))
        else:
            print("Product {} are not normal after correcting for autocorrelation.".format(y.name))
